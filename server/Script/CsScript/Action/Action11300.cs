...
namespace GameServer.CsScript.Action
{
    ...
    /// 11300_红包
    /// </summary>
    public class Action11300 : BaseAction
    {
        private JPBuyData receipt;

        public Action11300(ActionGetter actionGetter)
            : base(ActionIDDefine.Cst_Action11300, actionGetter)
        {
        ...
        public override bool TakeAction()
        {
            ...
            if (ContextUser.IsReceivedRedPacket)
            {
            ...
            //ContextUser.IsReceivedRedPacket = true;
            UserHelper.GiveAwayDiamond(ContextUser.UserID, diamondNum);
