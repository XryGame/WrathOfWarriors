...
namespace GameServer.Script.Model.DataModel
{
    ...
    public class GameUser : BaseUser
    {
        ...
        /// 分享数据
        /// </summary>
        private UserShareData _ShareData;
        [ProtoMember(59)]
        [EntityField(true, ColumnDbType.LongText)]
        public UserShareData ShareData
        {
            get
            {
                return _ShareData;
        ...
        public void UserLevelUp()
        {
            ...
            if (UserLv % 2 == 0 && ClassData.ClassID != 0)
            {// 将用户从原有班级中剔除
                ClassDataCache oldclass = new ShareCacheStruct<ClassDataCache>().FindKey(ClassData.ClassID);
                if (oldclass != null)
                {
            ...
            if (Callback != null && !IsRefreshing)
            {
                Callback.BeginInvoke("LevelUp", UserID, ClassData.ClassID, isMonitor, null, this);
            }
